...
static TCHAR const *const gl_straErrorCodeStrings[] = {
	...
	TEXT("Marble_ErrorCode_AppState"),
	TEXT("Marble_ErrorCode_ComponentInitState"),
	...
	TEXT("Marble_ErrorCode_ResizeRendererBuffers"),
	TEXT("Marble_ErrorCode_HeadValidation"),
	TEXT("Marble_ErrorCode_AssetType"),
	TEXT("Marble_ErrorCode_AssetID"),
...
static TCHAR const *const gl_straErrorCodeDescs[] = {
	...
	TEXT("Could not read from file. Causes can be software (handle invalid?)-related or an unexpected end-of-file (EOF)."),
	...
	TEXT("Operation could not be carried out due to one or mode components not being available."),
	...
	TEXT("Could not resize renderer buffers."),
	...
	TEXT("Invalid asset ID. This can mean empty or already registered. Keep asset identifiers unique.\n"),
