...
_WR_EXTERN_C_ HRESULT                  WINAPI D2DWr_RenderTarget_CreateCompatibleRenderTarget(ID2D1RenderTarget *sRenderTarget, D2D1_SIZE_F const *sDesiredSize, D2D1_SIZE_U const *sDesiredPixelSize, D2D1_PIXEL_FORMAT const *sDesiredPixelFormat, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS eOptions, ID2D1BitmapRenderTarget **ptrpCompBitmapRenderTarget);
...
_WR_EXTERN_C_ D2D1_ANTIALIAS_MODE      WINAPI D2DWr_RenderTarget_GetAntialiasMode(ID2D1RenderTarget *sRenderTarget);
...
_WR_EXTERN_C_ D2D1_PIXEL_FORMAT        WINAPI D2DWr_RenderTarget_GetPixelFormat(ID2D1RenderTarget *sRenderTarget);
...
_WR_EXTERN_C_ D2D1_TEXT_ANTIALIAS_MODE WINAPI D2DWr_RenderTarget_GetTextAntialiasMode(ID2D1RenderTarget *sRenderTarget);
...
_WR_EXTERN_C_ void                     WINAPI D2DWr_RenderTarget_PushAxisAlignedClip(ID2D1RenderTarget *sRenderTarget, D2D1_RECT_F const *sClipRect, D2D1_ANTIALIAS_MODE eAntialiasingMode);
...
_WR_EXTERN_C_ void                     WINAPI D2DWr_RenderTarget_SetAntialiasMode(ID2D1RenderTarget *sRenderTarget, D2D1_ANTIALIAS_MODE eAntialiasingMode);
...
_WR_EXTERN_C_ void                     WINAPI D2DWr_RenderTarget_SetTextAntialiasMode(ID2D1RenderTarget *sRenderTarget, D2D1_TEXT_ANTIALIAS_MODE eTextAntialiasingMode);
